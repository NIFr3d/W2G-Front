...
export class SerieComponent implements OnInit{
  ...
  ngOnInit() {
    this.videoService.getSeasons(this.serverIp, this.serie).subscribe(seasons => {
  ...
  getEpisodes(season: string) {
    this.videoService.getEpisodes(this.serverIp, this.serie, season).subscribe(episodes => {
